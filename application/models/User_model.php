...
class User_model extends CI_Model {
    ...
    public function add_user($data){
        ...
        if((in_array($data['type'], array(1,2))) && ($data['email'])){
            ...
            $this->email->subject("Welcome to Olive Homes");
            $this->email->message("Welcome to Olive Homes CRM System,<br><br>Your user name is ".$data['emp_code']." And password is ".$data['emp_code']." by using them please login to the tool with the following link: <a href=\"https://crm.olivehomes.in//\" >https://crm.olivehomes.in//</a> <br><br>Regards Olive Homes IT team");
            $this->email->send();
        }
