...
<div class="container">
    <div class="page-header">
        ...
        <form method="post" name="callback_details" autocomplete="off" enctype="multipart/form-data">
        <div class="row">
            <div class="">
...
With reference to your site visit on  assisted by Mr. abhishek from Olive Homes, we thank you for giving us an opportunity to serve you in searching your dream home.  At OLV it is our endeavour to help you with all the possible Property options which will suit your requirement. Mr.  from OLV will be at your service. He/she will be there to assist you in searching your dream home.
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/dropzone/4.3.0/min/dropzone.min.js" type="text/javascript"></script>
                        ...
                        <div class="form-group">
                            <label class="control-label">Docuemnts</label>
                            <div class="">
...
$(document).ready(function() {
    ...
    var notesClient = "Greetings From Olive Homes.\n\nWith reference to your site visit on {site_visit_date} assisted by Mr. {site_assigned_by} from Olive Homes, we thank you for giving us an opportunity to serve you in searching your dream home.  At OLV it is our endeavour to help you with all the possible Property options which will suit your requirement. Mr. {relationship_manager} from OLV will be at your service. He/she will be there to assist you in searching your dream home.\n\n1. Home search - Assisting and helping you find your dream home suiting your requirements by giving you info on market trends, legalities, site visit assistance etc.\n\n2. Home loan Assistance - We will take away your pain of running around the banks to get your loan approved by giving doorstep service of bankers of your choice at your place.\n\n3. Property Purchase Assistance - Ensuring that your home buying becomes a pleasant experience our Relationship Manager will be there throughout the process Of documentation.\n\n4. Post sales Service – This is what differentiates us from others. We will be there for all possible help and guidance till you move into your home.\n\n5. Interior Services - We are tied With best interior designers in the city who give the best designs and execute them at a competitive price.\n\n\nFor any escalations/ complaints please write to admin@leads.com\n\nRegards\n\nTeam Olive Homes Services Pvt Ltd";
    ...
    $(".document").dropzone({
        ...
        success: function (result, xhr) {
            ...
            if (obj.type == 0) {
                $("#hiddenimages").append('<input type="hidden" name="documents[]" id="documents[]" value="' + obj.path + '">');
            } else {
                $("#hiddenimages").append('<input type="hidden" name="documents[]" id="documents[]"  value="' + obj.path + '">');
            }
        },
        ...
        removedfile: function (file) {
            var base_url = "crm.olivehomes.in";
