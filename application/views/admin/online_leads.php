	...
	<!-- <div class="container" style="overflow:auto;height: 27rem;overflow-y: scroll;"> -->
	  ...
	  <table id="example" class="table table-striped table-bordered dt-responsive"  cellspacing="0" width="100%" >
			<thead>
				...
				<tr>
					<td colspan="8"><input type='checkbox' id="checkAll"  class='check'  >Select All <input type="hidden" name="delete_leads" id="delete_leads" value="">
							<button type="submit" class="btn btn-success btn-block" id="del_button"style="margin-left: 20px;
    width: 20%;" name="delete_data" value="1" disabled=""> Delete Data</button>
							<script>
		...
		<div class="row">
			<div class="col-sm-6 col-sm-offset-3">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<select type="email" class="form-control" name="user" id="user" required>
                ...
                <br>
                    ...
                    <div class="col-sm-9">
                        <select type="email" class="form-control" name="project" id="project" required>
...
$(".check").click(function(){
     ...
     $('#project').prop('required',false);
        $('#del_button').prop('disabled',false);
    //  var del =document.getElementById("delete_leads").value;
    //  if(del)
    //  {
    //     $('#project').prop('required',false);
    //     $('#del_button').prop('disabled',false);
